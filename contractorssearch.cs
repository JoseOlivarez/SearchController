...
namespace Cascade0.Controllers
{
    ...
    [ApiController]
    public class Contractors1Controller : ControllerBase
    {
        ...
        public Contractors1Controller()
        {
            DDSPRODDBContext context = new DDSPRODDBContext();
            _context = context;
        }
        private IQueryable<Contractor> GenerateClause(string propName, string selectedOperator, ContractorSignUpDTO Emp)
        {
            var propertyInfo = typeof(Contractor).GetProperty(propName);
            object fieldValue;
        ...
        private IQueryable<Contractor> GenerateClause2(string propName, string propName2, string selectedOperator, string selectedOperator2, ContractorSignUpDTO Emp)
        {
            var propertyInfo = typeof(Contractor).GetProperty(propName);
            var propertyInfo2 = typeof(Contractor).GetProperty(propName2);

            object fieldValue; object fieldValue2;
            fieldValue2 = Emp.parameterValue2;
            fieldValue = Emp.parameterValue;
            var db = _context.Contractor.Where(PropertyEquals2<Contractor, string>(propertyInfo, propertyInfo2, selectedOperator, selectedOperator2, Emp.parameterValue, Emp.parameterValue2, Emp));
            return db;
        }
        private IQueryable<Contractor> GenerateClause3(string propName, string propName2, string propName3, string selectedOperator, string selectedOperator2, string selectedOperator3, ContractorSignUpDTO Emp)
        {
            var propertyInfo = typeof(Contractor).GetProperty(propName);
            var propertyInfo2 = typeof(Contractor).GetProperty(propName2);
            var propertyInfo3 = typeof(Contractor).GetProperty(propName3);

            var db = _context.Contractor.Where(PropertyEquals3<Contractor, string>(propertyInfo, propertyInfo2, propertyInfo3, selectedOperator, selectedOperator2, selectedOperator3, Emp));
        ...
        private IQueryable<Contractor> GenerateClause4(string propName, string propName2, string propName3, string propName4, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4, ContractorSignUpDTO Emp)
        {
            var propertyInfo = typeof(Contractor).GetProperty(propName);
            var propertyInfo2 = typeof(Contractor).GetProperty(propName2);
            var propertyInfo3 = typeof(Contractor).GetProperty(propName3);
            var propertyInfo4 = typeof(Contractor).GetProperty(propName4);

            var db = _context.Contractor.Where(PropertyEquals4<Contractor, string>(propertyInfo, propertyInfo2, propertyInfo3, propertyInfo4, selectedOperator, selectedOperator2, selectedOperator3, selectedOperator4, Emp));
        ...
        public virtual Expression<Func<Contractor, bool>> WhereFilter
        {
            get { return x => true; }
        }
        ...
        // GET: api/Employees1
        [Route("GetEmployee")]
        public async Task<List<Contractor>> GetEmployee(string propName, [FromBody] ContractorSignUpDTO employee, string selectedOperator)
        {
        ...
        public async Task<List<Contractor>> GetQuerySetThree(string propName, string propName2, string propName3, [FromBody] ContractorSignUpDTO employee, string selectedOperator, string selectedOperator2, string selectedOperator3)
        {
        ...
        public async Task<List<Contractor>> GetQuerySetFour(string propName, string propName2, string propName3, string propName4, [FromBody] ContractorSignUpDTO employee, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4)
        {
        ...
        public async Task<List<Contractor>> GetQuerySetTwo(string propName, string propName2, [FromBody] ContractorSignUpDTO employee, string selectedOperator, string selectedOperator2)
        {
            string columnName = employee.columnName;
            var parameterValue = employee.parameterValue;
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals3<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, PropertyInfo propName3, string selectedOperator, string selectedOperator2, string selectedOperator3, ContractorSignUpDTO employee)
        {

            var parameter = Expression.Parameter(typeof(Contractor)); var expressionParameter = GetMemberExpression<T>(parameter, propName.Name);
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals4<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, PropertyInfo propName3, PropertyInfo propName4, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4, ContractorSignUpDTO employee)
        {
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals2<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, string selectedOperator, string selectedOperator2, object value, object value2, ContractorSignUpDTO employee)
        {
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals1<TItem, TValue>(PropertyInfo propName, string selectedOperator, string propNameString, object fieldValue, ContractorSignUpDTO employee)
        {
            bool where;
            Type myType = typeof(Contractor);
            ...
            MethodInfo contains = typeof(string).GetMethod("Contains", new[] { typeof(string) });
            MethodInfo startsWith = typeof(string).GetMethod("StartsWith", new Type[] { typeof(string) });
            PropertyDescriptorCollection props = TypeDescriptor.GetProperties(typeof(Contractor));
