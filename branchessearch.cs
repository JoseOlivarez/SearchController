...
namespace Cascade0.Controllers
{
    ...
    [ApiController]
    public class BranchSearchController : ControllerBase
    {
        ...
        public BranchSearchController()
        {
            DDSPRODDBContext context = new DDSPRODDBContext();
            _context = context;
        }
        private IQueryable<Branch> GenerateClause(string propName, string selectedOperator, BranchDTO Emp)
        {
        ...
        private IQueryable<Branch> GenerateClause2(string propName, string propName2, string selectedOperator, string selectedOperator2, BranchDTO Emp)
        {
            var propertyInfo = typeof(Branch).GetProperty(propName);
            ...
            fieldValue = Emp.parameterValue;
            var db = _context.Branch.Where(PropertyEquals2<Branch, string>(propertyInfo, propertyInfo2, selectedOperator, selectedOperator2, Emp.parameterValue, Emp.parameterValue2, Emp));
            return db;
        }
        private IQueryable<Branch> GenerateClause3(string propName, string propName2, string propName3, string selectedOperator, string selectedOperator2, string selectedOperator3, BranchDTO Emp)
        {
            var propertyInfo = typeof(Branch).GetProperty(propName);
            var propertyInfo2 = typeof(Branch).GetProperty(propName2);
            var propertyInfo3 = typeof(Branch).GetProperty(propName3);

            var db = _context.Branch.Where(PropertyEquals3<Branch, string>(propertyInfo, propertyInfo2, propertyInfo3, selectedOperator, selectedOperator2, selectedOperator3, Emp));
        ...
        private IQueryable<Branch> GenerateClause4(string propName, string propName2, string propName3, string propName4, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4, BranchDTO Emp)
        {
            var propertyInfo = typeof(Branch).GetProperty(propName);
            var propertyInfo2 = typeof(Branch).GetProperty(propName2);
            var propertyInfo3 = typeof(Branch).GetProperty(propName3);
            var propertyInfo4 = typeof(Branch).GetProperty(propName4);
        ...
        // GET: api/Employees1
        [Route("GetEmployee")]
        public async Task<List<Branch>> GetEmployee(string propName, [FromBody] BranchDTO employee, string selectedOperator)
        {
        ...
        public async Task<List<Branch>> GetQuerySetThree(string propName, string propName2, string propName3, [FromBody] BranchDTO employee, string selectedOperator, string selectedOperator2, string selectedOperator3)
        {
        ...
        public async Task<List<Branch>> GetQuerySetFour(string propName, string propName2, string propName3, string propName4, [FromBody] BranchDTO employee, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4)
        {
        ...
        public async Task<List<Branch>> GetQuerySetTwo(string propName, string propName2, [FromBody] BranchDTO employee, string selectedOperator, string selectedOperator2)
        {
            string columnName = employee.columnName;
            var parameterValue = employee.parameterValue;
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals3<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, PropertyInfo propName3, string selectedOperator, string selectedOperator2, string selectedOperator3,   BranchDTO employee)
        {
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals4<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, PropertyInfo propName3, PropertyInfo propName4, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4,  BranchDTO employee)
        {
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals2<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, string selectedOperator, string selectedOperator2, object value, object value2, BranchDTO employee)
        {
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals1<TItem, TValue>(PropertyInfo propName, string selectedOperator, string propNameString, object fieldValue, BranchDTO employee)
        {
            bool where;
