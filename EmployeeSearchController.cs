...
namespace Cascade0.Controllers
{
    ...
    public class Employees1Controller : ControllerBase
    {
        ...
        private IQueryable<Employee> GenerateClause2(string propName, string propName2, string selectedOperator, string selectedOperator2, EmployeeSignUpDTO Emp)
        {
            ...
            fieldValue = Emp.parameterValue;
            var db = _context.Employee.Where(PropertyEquals2<Employee, string>(propertyInfo, propertyInfo2, selectedOperator, selectedOperator2, Emp.parameterValue, Emp.parameterValue2, Emp));
            return db;
        }
        private IQueryable<Employee> GenerateClause3(string propName, string propName2, string propName3, string selectedOperator, string selectedOperator2, string selectedOperator3, EmployeeSignUpDTO Emp)
        {
            ...
            var db = _context.Employee.Where(PropertyEquals3<Employee, string>(propertyInfo, propertyInfo2, propertyInfo3, selectedOperator, selectedOperator2, selectedOperator3, Emp));
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals3<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, PropertyInfo propName3, string selectedOperator, string selectedOperator2, string selectedOperator3, EmployeeSignUpDTO employee)
        {
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals2<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, string selectedOperator, string selectedOperator2, object value, object value2, EmployeeSignUpDTO employee)
        {
