...
namespace Cascade0.Controllers
{
    ...
    [ApiController]
    public class GenericContractorSearch : ControllerBase
    {
        ...
        public GenericContractorSearch(IOnPageLoadHelper onPageLoadHelper, IUserHelper userHelper)
        {
        ...
        private IQueryable<Contractor> GenerateClause(string propName, string selectedOperator, GenericObject Emp)
        {
            var propertyInfo = typeof(T).GetProperty(propName);
            object fieldValue;
            fieldValue = Emp.parameterValue;
            var db = _context.Contractor.Where(PropertyEquals1<Contractor, string>(propertyInfo, selectedOperator, propName, fieldValue, Emp));
            return db;
        }
        private IQueryable<Contractor> GenerateClause2(string propName, string propName2, string selectedOperator, string selectedOperator2, GenericObject Emp)
        {
            var propertyInfo = typeof(T).GetProperty(propName);
            ...
            fieldValue = Emp.parameterValue;
            var db = _context.Contractor.Where(PropertyEquals2<Contractor, string>(propertyInfo, propertyInfo2, selectedOperator, selectedOperator2, Emp.parameterValue, Emp.parameterValue2, Emp, propName, propName2));
            return db;
        }
        private IQueryable<Contractor> GenerateClause3(string propName, string propName2, string propName3, string selectedOperator, string selectedOperator2, string selectedOperator3, GenericObject Emp)
        {
            var propertyInfo = typeof(T).GetProperty(propName);
            var propertyInfo2 = typeof(T).GetProperty(propName2);
            var propertyInfo3 = typeof(T).GetProperty(propName3);

            var db = _context.Contractor.Where(PropertyEquals3<Contractor, string>(propertyInfo, propertyInfo2, propertyInfo3, selectedOperator, selectedOperator2, selectedOperator3, Emp, propName, propName2, propName3)); ;
        ...
        private IQueryable<Contractor> GenerateClause4(string propName, string propName2, string propName3, string propName4, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4, GenericObject Emp)
        {
            var propertyInfo = typeof(T).GetProperty(propName);
            var propertyInfo2 = typeof(T).GetProperty(propName2);
            ...
            var db = _context.Contractor.Where(PropertyEquals4<Contractor, string>(propertyInfo, propertyInfo2, propertyInfo3, propertyInfo4, Emp, selectedOperator, selectedOperator2, selectedOperator3, selectedOperator4, propName, propName2, propName3, propName4));
        ...
        [HttpPost]
        // GET: api/GenericContractorSearch
        [Route("GetTSet1")]
        public async Task<List<Contractor>> GetT(string propName, [FromBody] GenericObject T, string selectedOperator)
        {
        ...
        [HttpPost]
        [Route("GetTSet3")]
        public async Task<List<Contractor>> GetQuerySetThree(string propName, string propName2, string propName3, [FromBody] GenericObject T, string selectedOperator, string selectedOperator2, string selectedOperator3)
        {
        ...
        [HttpPost]
        [Route("GetTSet4")]
        public async Task<List<Contractor>> GetQuerySetFour(string propName, string propName2, string propName3, string propName4, [FromBody] GenericObject T, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4)
        {
        ...
        [HttpPost]
        [Route("GetTSet2")]
        public async Task<List<Contractor>> GetQuerySetTwo(string propName, string propName2, [FromBody] GenericObject T, string selectedOperator, string selectedOperator2)
        {
            string columnName = T.columnName;
            var parameterValue = T.parameterValue;
        ...
        {
            bool where;
            Type myType = typeof(Contractor);
            var PropertyInfo = myType.GetProperty(propNameString);

            var parameter = Expression.Parameter(typeof(Contractor));
                        ...
                        switch (selectedOperator)
                        {
                            ...
                            case "Like":
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var right = Expression.Constant(T.parameterValue, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    GenericContractorSearch.bodyLike = Expression.Call(Expression.Property(parameter, propName), contains, right);

                                    if (body != null)
                                    {
                                        body = Expression.Or(GenericContractorSearch.bodyLike, body);
                                        return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                    ...
                                    {
                                        body =
                                     Expression.Or(GenericContractorSearch.bodyLike, GenericContractorSearch.bodyLike);
                                        return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            ...
                            case "StartsWith":
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var right = Expression.Constant(T.parameterValue, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    GenericContractorSearch.bodyLike = Expression.Call(Expression.Property(parameter, propName), StartsWith, right);
                    ...
                    switch (selectedOperator)
                    {
                        ...
                        case "Like":
                            ...
                            if (xs != null)
                            {
                                ...
                                if (body != null)
                                {
                                    body = Expression.And(GenericContractorSearch.bodyLike, body);
                                    break;
                                ...
                                {
                                    body =
                                 Expression.And(GenericContractorSearch.bodyLike, GenericContractorSearch.bodyLike);
                                    break;
                    ...
                    if (!string.IsNullOrWhiteSpace(T.parameterValue3))
                    {
                        switch (selectedOperator3)
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.Equal(Expression.Property(parameter, propName3), Expression.Constant(T.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);
                                break;
                            case "NotEqual":
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.NotEqual(Expression.Property(parameter, propName3), Expression.Constant(T.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);
                            ...
                            case "LessThan":
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.LessThan(Expression.Property(parameter, propName3), Expression.Constant(T.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);
                                break;
                            case "LessThanOrEqual":
                                xs = myType.GetProperty(propNameString3);
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.LessThanOrEqual(Expression.Property(parameter, propName3), Expression.Constant(T.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);
                                break;
                            case "GreaterThan":
                                xs = myType.GetProperty(propNameString3);
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.GreaterThan(Expression.Property(parameter, propName3), Expression.Constant(T.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);
                                break;
                            case "GreaterThanOrEquals":
                                xs = myType.GetProperty(propNameString3);
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.GreaterThanOrEqual(Expression.Property(parameter, propName3), Expression.Constant(T.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);
                                break;
                            case "Like":
                                xs = myType.GetProperty(propNameString3);
                                ...
                                if (GenericContractorSearch.body != null)
                                {
                                    GenericContractorSearch.body = Expression.And(bodyLike, GenericContractorSearch.body); return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);

                                    return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                }
                                else
                                {
                                    GenericContractorSearch.body =
                                 Expression.And(bodyLike, bodyLike); return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);
                    ...
                    if (T.parameterValueDateTime3 > DateTime.MinValue)
                    {
                        switch (selectedOperator3)
                        {
                            ...
                            case "Like":
                                ...
                                if (GenericContractorSearch.body != null)
                                {
                                    GenericContractorSearch.body = Expression.And(bodyLike, GenericContractorSearch.body);
                                    return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);
                                    break;
                                }
                                else
                    ...
                    if (T.parameterValueInt3 != null)
                    {
                        switch (selectedOperator3)
                        {
                            ...
                            case "Like":
                                ...
                                if (GenericContractorSearch.body != null)
                                {
                                    GenericContractorSearch.body = Expression.Or(bodyLike, GenericContractorSearch.body);
                                    return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);
                                    break;
                                }
                                else
                    ...
                    if (!string.IsNullOrWhiteSpace(T.parameterValue4))
                    {
                        switch (selectedOperator4)
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.Equal(Expression.Property(parameter, propName4), Expression.Constant(T.parameterValue4)));
                                return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                break;
                            case "NotEqual":
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.NotEqual(Expression.Property(parameter, propName4), Expression.Constant(T.parameterValue4)));
                                return Expression.Lambda<Func<TItem, bool>>(GenericContractorSearch.body, parameter);
                            ...
                            case "LessThan":
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.LessThan(Expression.Property(parameter, propName4), Expression.Constant(T.parameterValue4)));
                                return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                break;
                                break;
                            case "LessThanOrEqual":
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.LessThanOrEqual(Expression.Property(parameter, propName4), Expression.Constant(T.parameterValue4))); return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            ...
                            case "GreaterThan":
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.GreaterThan(Expression.Property(parameter, propName4), Expression.Constant(T.parameterValue4))); return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            ...
                            case "GreaterThanOrEquals":
                                ...
                                body = Expression.And(GenericContractorSearch.body, Expression.GreaterThanOrEqual(Expression.Property(parameter, propName4), Expression.Constant(T.parameterValue4))); return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            ...
                            case "Like":
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var right = Expression.Constant(T.parameterValue4, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    GenericContractorSearch.bodyLike = Expression.Call(Expression.Property(parameter, propName4), contains, right);

                                    if (body != null)
                                    {
                                        body = Expression.And(GenericContractorSearch.bodyLike, body); return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                    ...
                                    {
                                        body =
                                     Expression.And(GenericContractorSearch.bodyLike, GenericContractorSearch.bodyLike); return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            ...
                            case "StartsWith":
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var right = Expression.Constant(T.parameterValue4, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    GenericContractorSearch.bodyLike = Expression.Call(Expression.Property(parameter, propName4), StartsWith, right);
