...
namespace Cascade0.Controllers
{
    ...
    public class Employees1Controller : ControllerBase
    {
        ...
        private IQueryable<Employee> GenerateClause(string propName, string selectedOperator, EmployeeSignUpDTO Emp)
        {
        ...
        private IQueryable<Employee> GenerateClause2(string propName, string propName2, string selectedOperator, string selectedOperator2, EmployeeSignUpDTO Emp)
        {
            var propertyInfo = typeof(Employee).GetProperty(propName);
        ...
        private IQueryable<Employee> GenerateClause3(string propName, string propName2, string propName3, string selectedOperator, string selectedOperator2, string selectedOperator3, EmployeeSignUpDTO Emp)
        {
        ...
        private IQueryable<Employee> GenerateClause4(string propName, string propName2, string propName3, string propName4, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4, EmployeeSignUpDTO Emp)
        {
            var propertyInfo = typeof(Employee).GetProperty(propName);
            var propertyInfo2 = typeof(Employee).GetProperty(propName2);
            var propertyInfo3 = typeof(Employee).GetProperty(propName3);
            ...
            var db = _context.Employee.Where(PropertyEquals4<Employee, string>(propertyInfo, propertyInfo2, propertyInfo3, propertyInfo4, selectedOperator, selectedOperator2, selectedOperator3, selectedOperator4, Emp));
        ...
        public virtual Expression<Func<Employee, bool>> WhereFilter
        {
            get { return x => true; }
        }
        ...
        [HttpPost]
        // GET: api/Employees1
        [Route("GetEmployeeSet1")]
        public async Task<List<Employee>> GetEmployee(string propName, [FromBody] EmployeeSignUpDTO employee, string selectedOperator)
        {
        ...
        public async Task<List<Employee>> GetQuerySetThree(string propName, string propName2, string propName3, [FromBody] EmployeeSignUpDTO employee, string selectedOperator, string selectedOperator2, string selectedOperator3)
        {
        ...
        public async Task<List<Employee>> GetQuerySetFour(string propName, string propName2, string propName3, string propName4, [FromBody] EmployeeSignUpDTO employee, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4)
        {
        ...
        public async Task<List<Employee>> GetQuerySetTwo(string propName, string propName2, [FromBody] EmployeeSignUpDTO employee, string selectedOperator, string selectedOperator2)
        {
            string columnName = employee.columnName;
            var parameterValue = employee.parameterValue;
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals1<TItem, TValue>(PropertyInfo propName, string selectedOperator, string propNameString, object fieldValue, EmployeeSignUpDTO employee)
        {
            bool where;
            Type myType = typeof(Employee);
            ...
            body = null;
            object x = ParseString(employee.paramaterValue1);
            if (employee.paramaterValue1 != null)
            {
                if (typeof(int) == ParseString(employee.paramaterValue1).GetType())
                {
                    employee.parameterValueInt = Convert.ToInt32(employee.paramaterValue1);

                }
                if (typeof(string) == ParseString(employee.paramaterValue1).GetType())
                {
                    employee.parameterValue = employee.paramaterValue1;
                }

                if (typeof(DateTime) == ParseString(employee.paramaterValue1).GetType())
                {
                    employee.parameterValueDateTime = Convert.ToDateTime(employee.paramaterValue1);
                ...
                if (selectedOperator == "contains")
                {
                    ...
                    {
                        bodyLike = Expression.Call(Expression.Property(parameter, propName), contains, Expression.Constant((employee.parameterValueInt4)));
                    }
                    if (propName.PropertyType == typeof(DateTime))
                    {
                        bodyLike = Expression.Call(Expression.Property(parameter, propName), contains, Expression.Constant((employee.parameterValueDateTime4, typeof(DateTime?))));
                    }
                    if (propName.PropertyType == typeof(string))
                    {
                        bodyLike = Expression.Call(Expression.Property(parameter, propName), contains, Expression.Constant((string)(employee.parameterValue4)));
                    }
                    else
                    {
                        bodyLike = Expression.Call(Expression.Property(parameter, propName), contains, Expression.Constant(Convert.ToString(employee.parameterValueUndeclared)));
                    ...
                    if (!string.IsNullOrWhiteSpace(employee.parameterValue))
                    {
                        switch (selectedOperator)
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                var xs = typeof(Employee).GetProperty(propNameString);
                                if (xs != null)
                                {
                                    Type t = Nullable.GetUnderlyingType(xs.PropertyType);
                                    //xs.SetValue(t, safeValue, null);
                                    var propertyInfo = typeof(Employee).GetProperty(propNameString);

                                    var propertyInfo2 = typeof(EmployeeSignUpDTO).GetProperty(propNameString);
                                    //however we can change what the constant is
                                    var right = Expression.Constant(employee.parameterValue, xs.PropertyType);
                                ...
                                return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            case "NotEqual":
                                xs = typeof(Employee).GetProperty(propNameString);
                                if (xs != null)
                                {
                                    Type t = Nullable.GetUnderlyingType(xs.PropertyType);
                                    //xs.SetValue(t, safeValue, null);
                            ...
                            case "Like":
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var right = Expression.Constant(employee.parameterValue, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    Employees1Controller.bodyLike = Expression.Call(Expression.Property(parameter, propName), contains, right);

                                    if (body != null)
                                    {
                                        body = Expression.Or(Employees1Controller.bodyLike, body);
                                        return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                    ...
                                    {
                                        body =
                                     Expression.Or(Employees1Controller.bodyLike, Employees1Controller.bodyLike);
                                        return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            ...
                            case "StartsWith":
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var right = Expression.Constant(employee.parameterValue, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    Employees1Controller.bodyLike = Expression.Call(Expression.Property(parameter, propName), StartsWith, right);
                        ...
                        switch (selectedOperator)
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter tSype node and return the equals exprsession set to the constant object and property type
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var propertyInfo2 = typeof(EmployeeSignUpDTO).GetProperty(propNameString);
                                    //however we can change what the constant is
                                    var right = Expression.Constant(employee.parameterValueInt, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    body = Expression.Equal(Expression.Property(parameter, propertyInfo), right);
                                    return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                }
                                body = Expression.Equal(Expression.Property(parameter, (propName)), Expression.Convert(Expression.Constant(employee.parameterValueInt), typeof(int)));
                                return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            case "NotEqual":
                                xs = typeof(Employee).GetProperty(propNameString);
                                if (xs != null)
                        ...
                        switch (selectedOperator)
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var propertyInfo2 = typeof(EmployeeSignUpDTO).GetProperty(propNameString);
                                    //however we can change what the constant is
                                    var right = Expression.Constant(employee.parameterValueDateTime, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals2<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, string selectedOperator, string selectedOperator2, object value, object value2, EmployeeSignUpDTO employee, string propNameString, string propNameString2)
        {

            var parameter = Expression.Parameter(typeof(Employee)); var expressionParameter = GetMemberExpression<T>(parameter, propName.Name);
            MethodInfo contains = typeof(string).GetMethod("Contains", new[] { typeof(string) });
            MethodInfo StartsWith = typeof(string).GetMethod("StartsWith", new Type[] { typeof(string) });
            ...
            if (employee.paramaterValue2 != null)
            {
                if (typeof(int) == ParseString(employee.paramaterValue2).GetType())
                {
                    employee.parameterValueInt2 = Convert.ToInt32(employee.paramaterValue2);

                }
                if (typeof(string) == ParseString(employee.paramaterValue2).GetType())
                {
                    employee.parameterValue2 = employee.paramaterValue2;
                }

                if (typeof(DateTime) == ParseString(employee.paramaterValue2).GetType())
                {
                    employee.parameterValueDateTime2 = Convert.ToDateTime(employee.paramaterValue2);
            ...
            if (employee != null)   // if the property is null and the object recieved is null we are going to write the appropriate expression and return it
            {
                    ...
                    switch (selectedOperator)
                    {
                        ...
                        case "Like":
                            ...
                            if (xs != null)
                            {
                                ...
                                if (body != null)
                                {
                                    body = Expression.And(Employees1Controller.bodyLike, body);
                                    break;
                                ...
                                {
                                    body =
                                 Expression.And(Employees1Controller.bodyLike, Employees1Controller.bodyLike);
                                    break;
                ...
                if (employee.Or == false)
                {
                    if (!string.IsNullOrWhiteSpace(employee.parameterValue2))
                    {
                        ...
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                var xs = typeof(Employee).GetProperty(propNameString2);
                                if (xs != null)
                                {
                                    Type t = Nullable.GetUnderlyingType(xs.PropertyType);
                                    //xs.SetValue(t, safeValue, null);
                                    var propertyInfo = typeof(Employee).GetProperty(propNameString2);

                                    var propertyInfo2 = typeof(EmployeeSignUpDTO).GetProperty(propNameString2);
                                    //however we can change what the constant is
                                    var right = Expression.Constant(employee.parameterValue2, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                ...
                                return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            case "NotEqual":
                                xs = typeof(Employee).GetProperty(propNameString2);
                                if (xs != null)
                                {
                                    Type t = Nullable.GetUnderlyingType(xs.PropertyType);
                                    //xs.SetValue(t, safeValue, null);
                        ...
                        switch (selectedOperator2)
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var propertyInfo2 = typeof(EmployeeSignUpDTO).GetProperty(propNameString2);
                                    //however we can change what the constant is
                                    var right = Expression.Constant(employee.parameterValueInt2, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    body = Expression.And(body, Expression.Equal(Expression.Property(parameter, propertyInfo), right));
                                    return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                }
                            ...
                            case "GreaterThanOrEquals":
                                ...
                                body = Expression.And(body, Expression.GreaterThanOrEqual(Expression.Property(parameter, propName), Expression.Constant(employee.parameterValueInt2, typeof(int?))));
                                return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            case "Like":
                                xs = typeof(Employee).GetProperty(propNameString2);
                        ...
                        switch (selectedOperator2)
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var propertyInfo2 = typeof(EmployeeSignUpDTO).GetProperty(propNameString2);
                                    //however we can change what the constant is
                                    var right = Expression.Constant(employee.parameterValueDateTime2, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                    ...
                    if (employee.parameterValueInt2 != null)
                    {
                        switch (selectedOperator2)
                        {
                            ...
                            case "GreaterThanOrEquals":
                                ...
                                body = Expression.Or(body, Expression.GreaterThanOrEqual(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValueInt2, typeof(int?))));
                                return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                            case "Like":
                                xs = typeof(Employee).GetProperty(propNameString2);
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals3<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, PropertyInfo propName3, string selectedOperator, string selectedOperator2, string selectedOperator3, EmployeeSignUpDTO employee, string propNameString, string propNameString2, string propNameString3)
        {
            var parameter = Expression.Parameter(typeof(Employee)); var expressionParameter = GetMemberExpression<T>(parameter, propName.Name);
            MethodInfo contains = typeof(string).GetMethod("Contains", new[] { typeof(string) });
            MethodInfo StartsWith = typeof(string).GetMethod("StartsWith", new Type[] { typeof(string) });
            ...
            if (employee.paramaterValue3 != null)
            {
                if (typeof(int) == ParseString(employee.paramaterValue3).GetType())
                {
                    employee.parameterValueInt3 = Convert.ToInt32(employee.paramaterValue3);

                }
                if (typeof(string) == ParseString(employee.paramaterValue3).GetType())
                {
                    employee.parameterValue3 = employee.paramaterValue3;
                }

                if (typeof(DateTime) == ParseString(employee.paramaterValue3).GetType())
                {
                    employee.parameterValueDateTime3 = Convert.ToDateTime(employee.paramaterValue3);

                }
            }
            if (employee.paramaterValue4 != null)
            {
                if (typeof(int) == ParseString(employee.paramaterValue4).GetType())
                {
                    employee.parameterValueInt4 = Convert.ToInt32(employee.paramaterValue4);

                }
                if (typeof(string) == ParseString(employee.paramaterValue4).GetType())
                {
                    employee.parameterValue4 = employee.paramaterValue4;
                }

                if (typeof(DateTime) == ParseString(employee.paramaterValue4).GetType())
                {
                    employee.parameterValueDateTime4 = Convert.ToDateTime(employee.paramaterValue4);
            ...
            if (employee != null)   // if the property is null and the object recieved is null we are going to write the appropriate expression and return it
            {
                ...
                if (employee.Or2 == false)
                {
                    if (!string.IsNullOrWhiteSpace(employee.parameterValue3))
                    {
                        ...
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                var xs = typeof(Employee).GetProperty(propNameString3);
                                if (xs != null)
                                {
                                    Type t = Nullable.GetUnderlyingType(xs.PropertyType);
                                    //xs.SetValue(t, safeValue, null);
                                    var propertyInfo = typeof(Employee).GetProperty(propNameString3);

                                    var propertyInfo2 = typeof(EmployeeSignUpDTO).GetProperty(propNameString3);
                                    //however we can change what the constant is
                                    var right = Expression.Constant(employee.parameterValue3, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    body = Expression.And(body, Expression.Equal(Expression.Property(parameter, propertyInfo), right));
                                    return Expression.Lambda<Func<TItem, bool>>(body, parameter);                            
                                }
                                body = Expression.And(Employees1Controller.body, Expression.Equal(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "NotEqual":
                                 xs = typeof(Employee).GetProperty(propNameString3);
                                if (xs != null)
                                {
                                    Type t = Nullable.GetUnderlyingType(xs.PropertyType);
                                    //xs.SetValue(t, safeValue, null);
                                ...
                                body = Expression.And(Employees1Controller.body, Expression.NotEqual(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                            ...
                            case "LessThan":
                                ...
                                body = Expression.And(Employees1Controller.body, Expression.LessThan(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "LessThanOrEqual":
                                xs = typeof(Employee).GetProperty(propNameString3);
                                ...
                                body = Expression.And(Employees1Controller.body, Expression.LessThanOrEqual(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "GreaterThan":
                                xs = typeof(Employee).GetProperty(propNameString3);
                                ...
                                body = Expression.And(Employees1Controller.body, Expression.GreaterThan(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "GreaterThanOrEquals":
                                xs = typeof(Employee).GetProperty(propNameString3);
                                ...
                                body = Expression.And(Employees1Controller.body, Expression.GreaterThanOrEqual(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "Like":
                                xs = typeof(Employee).GetProperty(propNameString3);
                                ...
                                if (Employees1Controller.body != null)
                                {
                                    Employees1Controller.body = Expression.And(bodyLike, Employees1Controller.body); return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);

                                    return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                }
                                else
                                {
                                    Employees1Controller.body =
                                 Expression.And(bodyLike, bodyLike); return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                        ...
                        switch (selectedOperator3)
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var propertyInfo2 = typeof(EmployeeSignUpDTO).GetProperty(propNameString3);
                                    //however we can change what the constant is
                                    var right = Expression.Constant(employee.parameterValueDateTime3, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    body = Expression.And(body, Expression.Equal(Expression.Property(parameter, propertyInfo), right));
                                    return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                }
                            ...
                            case "Like":
                                ...
                                if (Employees1Controller.body != null)
                                {
                                    Employees1Controller.body = Expression.And(bodyLike, Employees1Controller.body);
                                    return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                    break;
                                }
                                else
                    ...
                    if (!string.IsNullOrWhiteSpace(employee.parameterValue3))
                    {
                        switch (selectedOperator3)
                        {
                            ...
                            case "Like":
                                ...
                                bodyLike = Expression.Call(Expression.Property(parameter, propName2), contains, Expression.Constant(employee.parameterValue3));
                        ...
                        switch (selectedOperator3)
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                ...
                                if (xs != null)
                                {
                                    ...
                                    var propertyInfo2 = typeof(EmployeeSignUpDTO).GetProperty(propNameString3);
                                    //however we can change what the constant is
                                    var right = Expression.Constant(employee.parameterValueInt3, xs.PropertyType);
                                    // we cant change the value of the propertyInfo that keeps our variables in reflection with entity 
                                    body = Expression.And(body, Expression.Equal(Expression.Property(parameter, propertyInfo), right));
                                    return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                                }
                            ...
                            case "GreaterThan":
                                ...
                                body = Expression.And(body, Expression.GreaterThan(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValueInt3, typeof(int))));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "GreaterThanOrEquals":
                                xs = typeof(Employee).GetProperty(propNameString3);
                ...
                else
                {
                    if (employee.parameterValueInt3 != null)
                    {
                        switch (selectedOperator3)
                        {
                            ...
                            case "Like":
                                ...
                                if (Employees1Controller.body != null)
                                {
                                    Employees1Controller.body = Expression.Or(bodyLike, Employees1Controller.body);
                                    return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                    break;
                                }
                                else
                    ...
                    if (employee.parameterValue3 != null)
                    {
                        switch (selectedOperator3)
                        {
                            case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                                ...
                                body = Expression.Or(body, Expression.Equal(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "NotEqual":
                                xs = typeof(Employee).GetProperty(propNameString3);
                                ...
                                body = Expression.Or(body, Expression.NotEqual(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "LessThan":
                                xs = typeof(Employee).GetProperty(propNameString3);
                                ...
                                body = Expression.Or(body, Expression.LessThan(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "LessThanOrEqual":
                                xs = typeof(Employee).GetProperty(propNameString3);
                                ...
                                body = Expression.Or(body, Expression.LessThanOrEqual(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "GreaterThan":
                                xs = typeof(Employee).GetProperty(propNameString3);
                                ...
                                body = Expression.Or(body, Expression.GreaterThan(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "GreaterThanOrEquals":
                                xs = typeof(Employee).GetProperty(propNameString3);
                                ...
                                body = Expression.Or(body, Expression.GreaterThanOrEqual(Expression.Property(parameter, propName3), Expression.Constant(employee.parameterValue3)));
                                return Expression.Lambda<Func<TItem, bool>>(Employees1Controller.body, parameter);
                                break;
                            case "Like":
                                xs = typeof(Employee).GetProperty(propNameString3);
                            ...
                            case "StartsWith":
                                bodyLike = Expression.Call(Expression.Property(parameter, propName2), StartsWith, Expression.Constant(employee.parameterValue3, typeof(int?)));
        ...
        public static Expression<Func<TItem, bool>> PropertyEquals4<TItem, TValue>(PropertyInfo propName, PropertyInfo propName2, PropertyInfo propName3, PropertyInfo propName4, string selectedOperator, string selectedOperator2, string selectedOperator3, string selectedOperator4, EmployeeSignUpDTO employee)
        {
         ...
         Expression.And(bodyLike, bodyLike);
            ...
            if (employee.parameterValueDateTime2 == DateTime.MinValue)
            {
                ...
                {
                    case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                        body = Expression.Or(Employees1Controller.body, Expression.Equal(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValueDateTime2, typeof(DateTime?))));
                        break;
                    case "NotEqual":
                        body = Expression.Or(Employees1Controller.body, Expression.NotEqual(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValueDateTime2, typeof(DateTime?))));
                        break;
                    case "LessThan":
                        body = Expression.Or(Employees1Controller.body, Expression.LessThan(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValueDateTime2, typeof(DateTime?))));
                        break;
                    case "LessThanOrEqual":
                        body = Expression.Or(Employees1Controller.body, Expression.LessThanOrEqual(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValueDateTime2, typeof(DateTime?))));
                        break;
                    case "GreaterThan":
                        body = Expression.Or(Employees1Controller.body, Expression.GreaterThan(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValueDateTime2, typeof(DateTime?))));
                        break;
                    case "GreaterThanOrEquals":
                        body = Expression.Or(Employees1Controller.body, Expression.GreaterThanOrEqual(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValueDateTime2, typeof(DateTime?))));
                        break;
                    case "Like":
                        bodyLike = Expression.Call(Expression.Property(parameter, propName2), contains, Expression.Constant(employee.parameterValueDateTime2, typeof(DateTime?)));
            ...
            if (!string.IsNullOrWhiteSpace(employee.parameterValue2))
            {
                ...
                {
                    case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                        body = Expression.Or(Employees1Controller.body, Expression.Equal(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValue2)));
                        break;
                    case "NotEqual":
                        body = Expression.Or(Employees1Controller.body, Expression.NotEqual(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValue2)));
                        break;
                    case "LessThan":
                        body = Expression.Or(Employees1Controller.body, Expression.LessThan(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValue2)));
                        break;
                    case "LessThanOrEqual":
                        body = Expression.Or(Employees1Controller.body, Expression.LessThanOrEqual(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValue2)));
                        break;
                    case "GreaterThan":
                        body = Expression.Or(Employees1Controller.body, Expression.GreaterThan(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValue2)));
                        break;
                    case "GreaterThanOrEquals":
                        body = Expression.Or(Employees1Controller.body, Expression.GreaterThanOrEqual(Expression.Property(parameter, propName2), Expression.Constant(employee.parameterValue2)));
                        break;
                    case "Like":
                        bodyLike = Expression.Call(Expression.Property(parameter, propName2), contains, Expression.Constant(employee.parameterValue2));
            ...
            if (employee.Or3 == false)
            {
                if (!string.IsNullOrWhiteSpace(employee.parameterValue4))
                {
                    ...
                    {
                        case "Equals": //if the case is operations equals we Expression tree for a parameter type node and return the equals exprsession set to the constant object and property type
                            body = Expression.And(Employees1Controller.body, Expression.Equal(Expression.Property(parameter, propName4), Expression.Constant(employee.parameterValue4)));
                            return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                        case "NotEqual":
                            body = Expression.And(Employees1Controller.body, Expression.NotEqual(Expression.Property(parameter, propName4), Expression.Constant(employee.parameterValue4)));
                            return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                        case "LessThan":
                            body = Expression.And(Employees1Controller.body, Expression.LessThan(Expression.Property(parameter, propName4), Expression.Constant(employee.parameterValue4)));
                            return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                        case "LessThanOrEqual":
                            body = Expression.And(Employees1Controller.body, Expression.LessThanOrEqual(Expression.Property(parameter, propName4), Expression.Constant(employee.parameterValue4)));
                            return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                        case "GreaterThan":
                            body = Expression.And(Employees1Controller.body, Expression.GreaterThan(Expression.Property(parameter, propName4), Expression.Constant(employee.parameterValue4)));
                            return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                        case "GreaterThanOrEquals":
                            body = Expression.And(Employees1Controller.body, Expression.GreaterThanOrEqual(Expression.Property(parameter, propName4), Expression.Constant(employee.parameterValue4)));
                            return Expression.Lambda<Func<TItem, bool>>(body, parameter);
                        case "Like":
